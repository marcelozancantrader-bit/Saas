...
export const PLANS: Record<PlanId, PlanInfo> = {
  ...
  solo: {
    ...
    label: "Solo",
    priceCents: 8990,
    description: "Autônomo com 1-3 projetos/mês.",
    features: [
      "5 projetos · 30 docs IA/mês",
      "Portal cliente + assinatura digital",
      "Portfólio público /p/seu-escritorio",
      "Branding completo (logo + cores)",
      "3 templates CAU + Memoriais técnicos",
  ...
  pro: {
    ...
    label: "Pro",
    priceCents: 21990,
    description: "Profissional consolidado, 5-10 projetos/mês.",
    highlighted: true,
    features: [
      "25 projetos · 150 docs IA/mês",
      "Tudo do Solo, mais:",
      "✨ Quantitativo IA da planta",
      "Diário de obra + WhatsApp Business",
      "Cotação de fornecedor + Chat da planta",
      "6 templates CAU + Biblioteca do escritório",
  ...
  studio: {
    ...
    label: "Studio",
    priceCents: 49990,
    description: "Escritório com equipe e aprovação interna.",
    features: [
      "Projetos ilimitados · 500 docs IA/mês",
      "Tudo do Pro, mais:",
