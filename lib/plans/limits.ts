...
export const PLANS: Record<PlanId, PlanInfo> = {
  free: {
    ...
    features: [
      "1 projeto · 3 documentos IA/mês",
      "Memorial descritivo NBR 13.531",
      "1 template de contrato CAU/CREA",
      "Orçamento SINAPI nacional",
  ...
  solo: {
    ...
    label: "Solo",
    priceCents: 8990,
    description: "Arquiteto ou engenheiro autônomo (1-3 projetos/mês).",
    features: [
      "5 projetos · 30 documentos IA/mês",
      "12 tipos de doc: memoriais (descritivo + 5 técnicos), caderno, proposta, contrato, briefing, aditivos, cronograma",
      "ART (CREA) e RRT (CAU) pré-preenchidas",
      "Análise NBR + zoneamento automático",
      "Orçamento SINAPI + CUB estadual + Curva ABC",
      "Portal do cliente + assinatura digital (MP 2.200-2)",
      "Portfólio público + branding completo",
      "5 GB de armazenamento · sem marca d'água",
    ],
    limits: SOLO_LIMITS,
  },
  pro: {
    ...
    label: "Pro",
    priceCents: 21990,
    description: "Profissional consolidado com 5-10 projetos/mês.",
    highlighted: true,
    features: [
      "Tudo do Solo, mais:",
      "25 projetos · 150 documentos IA/mês",
      "✨ Quantitativo IA da planta (portas, janelas, louças, rodapé)",
      "Diário de obra com fotos (prova legal datada)",
      "WhatsApp Business automático ao cliente",
      "Cotação de fornecedor (PDF + XLSX)",
      "Chat da planta (IA pro cliente no portal)",
      "6 templates CAU/CREA + Biblioteca do escritório",
      "3 usuários + suporte prioritário 24h",
  ...
  studio: {
    ...
    features: [
      "Tudo do Pro, mais:",
      "Projetos ilimitados · 500 documentos IA/mês",
      "Revisão hierárquica multi-user (júnior gera → sênior aprova)",
      "10 usuários + roles (owner, admin, member)",
      "API read-only",
  ...
  agency: {
    ...
    label: "Agência",
    priceCents: null,
    description: "Construtora ou escritório 10+ profissionais.",
    features: [
      "Tudo do Studio, mais:",
      "Tudo ilimitado (projetos, docs, usuários, storage)",
      "White-label completo (esconde marca)",
      "Multi-org (vários CNPJs)",
      "API completa (read + write)",
      "SLA dedicado + Slack prioritário",
